...
export const projects: Project[] = [
  {
    ...
    solution: 'Designed and built an autonomous AI agent that reads remittances, reconciles payments, and posts them end-to-end with no human in the loop — running 24/7.',
  ...
  },
  {
    ...
    solution: 'Built an agent that composes and submits appeals automatically, then monitors payer timelines and triggers escalation when reviewers exceed expected windows.',
    impact: 'Reduced appeal submission time by 2 months. Proactive follow-up automation turned a reactive process into a data-driven one.',
    tech: ['Python', 'RPA', 'AWS', 'Robocorp'],
    type: 'professional',
  },
  {
    ...
    solution: 'Built automation pipelines that ingested orders from diverse sources (email, Excel, scraped portals), cleaned and normalised the data, and pushed it through to back-end systems automatically.',
