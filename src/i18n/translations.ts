...
export const translations = {
  ...
  pt: {
    ...
    hero: {
      ...
      description:
        'Ex-engenheiro civil que virou desenvolvedor de software. Ajudo empresas a automatizar processos, reduzir custos operacionais e construir o software que elas realmente precisam. De ferramentas internas a sistemas em produção. 5+ anos transformando problemas complexos em soluções limpas e escaláveis',
      badges: [
        { label: 'Python', scheme: 'blue' },
        { label: 'React', scheme: 'cyan' },
        { label: 'AWS Certified', scheme: 'orange' },
    ...
    stats: [
      { value: '60 dias', label: 'backlog de faturamento eliminado', sub: '→ quase tempo real' },
      { value: '90%',     label: 'do tempo dos clientes economizado', sub: 'no processamento de pedidos' },
    ...
    about: {
      tag: '// quem sou eu',
      title: 'Sobre Mim',
      p1: 'Comecei minha carreira gerenciando obras de construção civil avaliadas em dezenas de milhões de reais - coordenando equipes, prazos e resolvendo problemas. Em 2021, apostei em mim mesmo e fiz a transição para software. Melhor decisão que já tomei. Esse histórico em engenharia e em fazer as coisas acontecerem ainda está no centro de como trabalho.',
      p2: 'Hoje construo software que ajuda empresas a automatizar o que é lento, caro e manual. Entendo os problemas em que um sistema bem projetado pode economizar meses de trabalho para uma equipe - e me preocupo muito em acertar os detalhes, porque nos fluxos em que trabalho, são os detalhes que fazem a diferença.',
      quickFacts: ['São Paulo, Brasil', 'Disponível para remoto', 'Inglês - Fluente'],
      volunteerTitle: 'Trabalho Voluntário',
      volunteerText: 'Contribuiu com análise de dados para apoiar as operações e tomada de decisões da ONG. Aplicando habilidades técnicas para impacto social fora do trabalho remunerado.',
    },
    timeline: {
      tag: '// minha história',
      title: 'A Jornada',
      subtitle: 'De obras de R$40M para software - não o caminho mais fácil, mas o certo.',
      keyMoment: 'momento-chave',
      eventTexts: {
        '1':  { role: 'Bacharelado em Engenharia Civil',          description: 'Construiu uma sólida base analítica e de resolução de problemas, pensamento sistemático e habilidades de gestão de grandes projetos que depois se traduziriam diretamente em engenharia de software.' },
        '2':  { role: 'Intercâmbio - Engenharia Civil',           description: 'Estudou no exterior e tornou-se fluente em inglês, abrindo portas para oportunidades internacionais e equipes globais.' },
        '3':  { role: 'Engenheiro Civil',                         description: 'Gerenciou equipes e orçamentos em uma obra de R$40M. Redesenhou o processo de aluguel de equipamentos e reduziu esses custos pela metade.' },
        '4':  { role: 'MBA em Gestão de Projetos',                description: 'Aprofundou expertise em gestão de riscos, planejamento e liderança de equipes multidisciplinares sob restrições.' },
        '5':  { role: 'Engenheiro Civil',                         description: 'Gerenciou mais de R$5M em projetos de infraestrutura municipal, supervisionando simultaneamente equipes em 15 canteiros de obras e garantindo entregas dentro do prazo e do orçamento.' },
        '6':  { role: 'Bootcamp de Desenvolvimento Web Full Stack', description: 'Após anos gerenciando construções, decidi construir software. Me comprometi com um bootcamp intensivo de full stack e nunca mais olhei para trás.' },
        '7':  { role: 'Professor Assistente',                     description: 'Mentorei mais de 50 alunos em desenvolvimento web. A melhor forma de aprender algo profundamente é ensinando.' },
        '8': {
          role: 'Desenvolvedor de Software',
          description: 'Construí automação de comércio B2B para a indústria de bens de consumo, economizando 90% do tempo de processamento manual de pedidos dos clientes.',
          highlights: [
            'Automatizou fluxo de pedidos para milhares de produtos diariamente',
            'Rotas de back-end com Flask, front-end com Vue',
            'Deploy no GCP Cloud Run para alta disponibilidade',
            'PostgreSQL para pipelines de tomada de decisão em tempo real',
            'Extração e limpeza de dados de Excel, PDFs e fontes com web scraping usando pandas',
          ],
        },
        '9':  { role: 'AWS Certified Cloud Practitioner',  description: '' },
        '10': { role: 'AWS Certified Developer Associate', description: '' },
        '11': {
          role: 'Forward Deployed Engineer',
          description: 'Construindo agentes de IA totalmente autônomos para Gestão do Ciclo de Receita em saúde, substituindo trabalho de faturamento manual por agentes que operam 24/7.',
          highlights: [
            'Agente de Registro de Pagamentos: eliminou um backlog de faturamento de 60 dias, acelerando a receita em 2 meses',
            'Agente de Envio de Recursos: reduziu o tempo de envio em 4 meses com automação de acompanhamento',
            'Estabeleceu estratégias de testes automatizados em fluxos de agentes',
            'Mentoria de novos engenheiros; apoio a fluxos de entrega CI/CD global',
            'Colaborou com equipes multifuncionais na América Latina e nos EUA para desenvolver e implementar soluções personalizadas',
            'Atuou diretamente com clientes provedores de saúde em sessões de levantamento de requisitos, demos de produto e chamadas de onboarding, garantindo soluções adaptadas aos fluxos operacionais de cada cliente',
          ],
        },
      } as Record<string, TimelineEventText>,
    },
    skills: {
      ...
      subtitle: 'Um conjunto de ferramentas construído ao longo de construção civil, ensino e desenvolvimento de produtos.',
      groupLabels: ['Backend', 'Frontend', 'Cloud & Infra', 'Dados & Bancos', 'IA & Automação', 'Boas Práticas'],
    },
    recommendations: {
      tag: '// prova social',
      title: 'Recomendações',
      subtitle: 'O que colegas e colaboradores dizem sobre trabalhar comigo.',
    },
    contact: {
      tag: '// entre em contato',
      title: 'Vamos Conversar',
      subtitle: 'Se você tem um projeto em mente, quer trabalhar junto ou só quer dizer oi, minha caixa de entrada está sempre aberta.',
      lookingForTag: '// o que estou buscando',
      lookingFor: [
        { label: 'Tipo de Vaga',  value: 'Back-end, full-stack ou com foco em IA / automação' },
        { label: 'Stack',         value: 'Python como principal — confortável em todo o full stack' },
        { label: 'Equipe',        value: 'Equipes distribuídas e internacionais onde autonomia é esperada' },
